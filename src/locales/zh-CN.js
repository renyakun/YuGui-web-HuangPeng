export default {
  ...
  'menu.home': '首页',
  'menu.house': '房源管理',
  'menu.house.analysis': '房源分析页',
  'menu.house.addResource': '新增房源',
  'menu.house.resource': '房源管理',
  'menu.house.newpage':'新测试页',
  'menu.workplatform':'我的工作台',
  'menu.workplatform.mytask':'任务处理',
  'menu.workplatform.waitcheckList':'待审核报告列表',
  ...
  'menu.reportmanager':'我的报告管理',
  'menu.reportmanager.basicform':'新建报告',
  'menu.reportmanager.newlist':'新建报告列表',
  'menu.reportmanager.checkedlist':'审核报告列表',
  'menu.reportmanager.approvelist':'审批报告列表',
  'menu.reportmanager.filelist':'归档报告列表',
  'menu.reportmanager.reportdetail':'提交审核详情',
  'menu.reportmanager.reportcheck':'提交审批详情',
  'menu.reportmanager.reportview':'报告打印',
  'menu.reportmanager.report':'报告详情',
  'menu.reportmanager.reportprint':'报告打印',
  'menu.system':'管理员信息',
  'menu.system.info':'个人信息',
  'menu.searchreport':'搜索报告',
  'menu.searchreport.searchreportlist':'搜索报告列表',
